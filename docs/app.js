const app = Vue.createApp({
    ...
    methods: {
        async startGame() {
            ...
            await fetch('https://numblegame.azurewebsites.net/game', method = {
                method: 'POST',
                headers: {
        ...
        .catch(err => {
            ...
            if(!this.hardMode)
            {
                fetch(`https://numblegame.azurewebsites.net/game/${this.gameId}/rhs`, method = {
                        method: "GET",
                        headers: {
                            'Content-Type' : 'application/json'
                        },
        ...
        sendEquation(event) {
            if (event.key == "Enter") {
                    ...
                    if(valid){
                        fetch(`https://numblegame.azurewebsites.net/game/${this.gameId}/guess`, method = {
                            method: "POST",
                            headers: {
                                'Content-Type' : 'application/json'
                            },
